...
a simple implementation in [[Technology:CSharp]] for [[Technology:.NET] Framework

== Technologies ==

* [[Technology:CSharp]](C#): Programming language used for all code (Version 4.0)
...
Relevant classes contain methods which implement the [[query]] for totaling salaries, the [[:Category:transformation]] for cutting salaries and a [[query]] to check department's
[[101feature:Depth]]. XML [[serialization]] for public [[Category:.NET]] classes is enabled by default, [[in-memory XML processing]] is used to create object model from XML file.
...
* ''FeaturesTest'' class which covers test cases for the features: [[101feature:total]], [[101feature:Cut]], [[101feature:Depth]].
