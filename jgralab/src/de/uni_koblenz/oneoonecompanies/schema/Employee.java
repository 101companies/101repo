...
public interface Employee extends de.uni_koblenz.oneoonecompanies.schema.Person {

	/**
	 * @return the next de.uni_koblenz.oneoonecompanies.schema.Employee vertex in the global vertex sequence
	 */
