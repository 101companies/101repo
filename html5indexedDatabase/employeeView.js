...
gui.generateFormular = function() {
	...
	content += "<tr><td colspan=\"2\"><input type=\"button\" class=\"button\" name=\"save\" value=\"save\" onclick=\"controller.save(" + employeeId + ", this.form.name.value, this.form.address.value, this.form.salary.value)\"></td></tr>";
	content += "</table>";
	content += "</form>";
